...
namespace DbFirstApp.Controllers
{
    public class LearnersController : Controller
    {
        ...
        public LearnersController(SchoolContextContext context)
        {
            _context = context;
        }
        ...
        {
            var schoolContextContext = _context.Learners.Include(l => l.Major);
            return View(await schoolContextContext.ToListAsync());
        }
